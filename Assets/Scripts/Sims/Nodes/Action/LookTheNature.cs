...
[CreateAssetMenu(menuName = MenuPaths.Nodes + "Sims/Actions/LookTheNature")]

public class LookTheNature : ActionNode<SimsController>
{
    ...
    public override void OnBeforeExecute()
    {
        ...
        Agent.besoins.besoins["Environnement"].isIncreasing = true;
