...
namespace PGSauce.Core
{
    ...
    public class ItemInspector
    {
        ...
        [MenuItem(MenuPaths.SelectObject + "Select PlayFab Settings")]
        public static void SelectPlayFabSettings()
        {
            OdinEditorWindow.InspectObject(PlayfabSettings.Instance).Show();
        }
