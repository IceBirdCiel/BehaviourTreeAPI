...
namespace PGSauce.Core.Strings
{
    ...
    {
        public const string MenuBase = "ESGI/";
        public const string Nodes = MenuBase + "Nodes/";
        ...
        public const string NodesActions = Nodes + "Actions/";
        public const string NodeVariables = Nodes + "Variables/";
    }
}
