...
public class MakeScriptableObject
{
    ...
    public static void MakePlayFabSharedSettings()
    {
        ...
        AssetDatabase.CreateAsset(asset, "Assets/__PGSauce/_Vendor/PlayFabSdk/Shared/Public/Resources/PlayFabSharedSettings.asset"); // TODO: Path should not be hard coded
